...
} from "./(InnertubePayload)/Title.ts";
import {
  Type as Description,
...
} from "./(InnertubePayload)/Description.ts";
import {
  Type as Tags,
...
} from "./(InnertubePayload)/Category.ts";
import {
  Type as License,
...
} from "./(InnertubePayload)/License.ts";
import {
...
} from "./(InnertubePayload)/VideoThumbnail.ts";
import {
  Type as Privacy,
...
} from "./(InnertubePayload)/Privacy.ts";
import {
  Type as MadeForKids,
...
} from "./(InnertubePayload)/MadeForKids.ts";
import {
...
} from "./(InnertubePayload)/AgeRestricted.ts";
import {
