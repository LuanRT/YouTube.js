...
Defined in: [src/utils/Utils.ts:60](https://github.com/LuanRT/YouTube.js/blob/853a36307b5d644ada14dcb1216c2c22c2ae7b73/src/utils/Utils.ts#L60)
...
> **new ChannelError**(`message?`): `ChannelError`
...
> **new ChannelError**(`message?`, `options?`): `ChannelError`
