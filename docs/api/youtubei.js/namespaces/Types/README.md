...
- [JsAnalyzer](classes/JsAnalyzer.md)
- [JsExtractor](classes/JsExtractor.md)
...
- [SideEffectPolicyOptions](interfaces/SideEffectPolicyOptions.md)
...
- [EvalResult](type-aliases/EvalResult.md)
- [ExtractionMatch](type-aliases/ExtractionMatch.md)
