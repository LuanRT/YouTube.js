...
import KidsBlocklistPickerItem from '../../parser/classes/channels/KidsBlocklistPickerItem.js';
...
export default class InteractionManager {
  ...
  async blockChannel(channel_id: string): Promise<ApiResponse[]> {
    ...
    const response = (await this.#actions.execute( KidsBlocklistPickerEndpoint.PATH, blocklist_payload ));     
