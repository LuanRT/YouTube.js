...
function defineInnertubePayload () {
  ...
  var VideoSettings = InnertubePayload.VideoSettings = {
    buffer: true,
    encodingLength: null,
    encode: null,
    decode: null
  ...
  function defineVideoSettings () {
    var Thumbnail = VideoSettings.Thumbnail = {
      buffer: true,
      encodingLength: null,
      encode: null,
      decode: null
    ...
    function defineThumbnail () {
      Thumbnail.encodingLength = encodingLength
      Thumbnail.encode = encode
      Thumbnail.decode = decode

      function encodingLength (obj) {
        var length = 0
        if (defined(obj.image_data)) {
          var len = encodings.bytes.encodingLength(obj.image_data)
          length += 1 + len
        }
        return length
      }
      ...
      function encode (obj, buf, offset) {
        ...
        if (defined(obj.image_data)) {
          buf[offset++] = 10
          encodings.bytes.encode(obj.image_data, buf, offset)
      ...
      function decode (buf, offset, end) {
        ...
        while (true) {
          ...
          switch (tag) {
            case 1:
            obj.image_data = encodings.bytes.decode(buf, offset)
    ...
    VideoSettings.encodingLength = encodingLength
    VideoSettings.encode = encode
    VideoSettings.decode = decode
    ...
    function encodingLength (obj) {
      ...
      if (defined(obj.thumbnail)) {
        var len = Thumbnail.encodingLength(obj.thumbnail)
        length += varint.encodingLength(len)
        length += 1 + len
      }
      return length
    ...
    function encode (obj, buf, offset) {
      ...
      if (defined(obj.thumbnail)) {
        buf[offset++] = 26
        varint.encode(Thumbnail.encodingLength(obj.thumbnail), buf, offset)
        offset += varint.encode.bytes
        Thumbnail.encode(obj.thumbnail, buf, offset)
        offset += Thumbnail.encode.bytes
      }
      encode.bytes = offset - oldOffset
      return buf
    }
    ...
    function decode (buf, offset, end) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          var len = varint.decode(buf, offset)
          offset += varint.decode.bytes
          obj.thumbnail = Thumbnail.decode(buf, offset, offset + len)
          offset += Thumbnail.decode.bytes
          break
          default:
          offset = skip(prefix & 7, buf, offset)
        }
  ...
  function encodingLength (obj) {
    ...
    if (defined(obj.video_settings)) {
      var len = VideoSettings.encodingLength(obj.video_settings)
      length += varint.encodingLength(len)
      length += 2 + len
    }
    return length
  ...
  function encode (obj, buf, offset) {
    ...
    if (defined(obj.video_settings)) {
      buf[offset++] = 162
      buf[offset++] = 1
      varint.encode(VideoSettings.encodingLength(obj.video_settings), buf, offset)
      offset += varint.encode.bytes
      VideoSettings.encode(obj.video_settings, buf, offset)
      offset += VideoSettings.encode.bytes
    }
    encode.bytes = offset - oldOffset
    return buf
  }
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      ...
      switch (tag) {
        ...
        var len = varint.decode(buf, offset)
        offset += varint.decode.bytes
        obj.video_settings = VideoSettings.decode(buf, offset, offset + len)
        offset += VideoSettings.decode.bytes
        break
        default:
        offset = skip(prefix & 7, buf, offset)
      }
