...
export type Type = $.youtube.MediaInfo.MediaCapabilities.AudioFormatCapability;
...
export function createValue(partialValue: Partial<$.youtube.MediaInfo.MediaCapabilities.AudioFormatCapability>): $.youtube.MediaInfo.MediaCapabilities.AudioFormatCapability {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.MediaInfo.MediaCapabilities.AudioFormatCapability): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.MediaInfo.MediaCapabilities.AudioFormatCapability {
...
export function encodeBinary(value: $.youtube.MediaInfo.MediaCapabilities.AudioFormatCapability): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.MediaInfo.MediaCapabilities.AudioFormatCapability {
  const result = getDefaultValue();
