...
export type Type = $.youtube.Upa.Gqa;
...
export function createValue(partialValue: Partial<$.youtube.Upa.Gqa>): $.youtube.Upa.Gqa {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.Upa.Gqa): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.Upa.Gqa {
...
export function encodeBinary(value: $.youtube.Upa.Gqa): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.Upa.Gqa {
  const result = getDefaultValue();
