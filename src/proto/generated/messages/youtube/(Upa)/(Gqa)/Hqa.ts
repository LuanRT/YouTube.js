...
export type Type = $.youtube.Upa.Gqa.Hqa;
...
export function createValue(partialValue: Partial<$.youtube.Upa.Gqa.Hqa>): $.youtube.Upa.Gqa.Hqa {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.Upa.Gqa.Hqa): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.Upa.Gqa.Hqa {
...
export function encodeBinary(value: $.youtube.Upa.Gqa.Hqa): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.Upa.Gqa.Hqa {
  const result = getDefaultValue();
