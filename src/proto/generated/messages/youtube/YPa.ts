...
export type Type = $.youtube.YPa;

export function getDefaultValue(): $.youtube.YPa {
  return {
    field1: undefined,
    field2: undefined,
    field3: undefined,
...
export function createValue(partialValue: Partial<$.youtube.YPa>): $.youtube.YPa {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.YPa): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.YPa {
...
export function encodeBinary(value: $.youtube.YPa): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.YPa {
  const result = getDefaultValue();
