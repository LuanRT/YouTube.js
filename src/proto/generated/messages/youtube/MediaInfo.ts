...
export type Type = $.youtube.MediaInfo;

export function getDefaultValue(): $.youtube.MediaInfo {
  return {
...
export function createValue(partialValue: Partial<$.youtube.MediaInfo>): $.youtube.MediaInfo {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.MediaInfo): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.MediaInfo {
...
export function encodeBinary(value: $.youtube.MediaInfo): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.MediaInfo {
  const result = getDefaultValue();
