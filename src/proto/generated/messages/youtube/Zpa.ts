...
export type Type = $.youtube.Zpa;

export function getDefaultValue(): $.youtube.Zpa {
  return {
    formatId: undefined,
...
export function createValue(partialValue: Partial<$.youtube.Zpa>): $.youtube.Zpa {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.Zpa): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.Zpa {
...
export function encodeBinary(value: $.youtube.Zpa): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.Zpa {
  const result = getDefaultValue();
