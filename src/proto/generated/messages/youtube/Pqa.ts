...
export type Type = $.youtube.Pqa;

export function getDefaultValue(): $.youtube.Pqa {
  return {
    formatIds: [],
    ud: [],
    clipId: undefined,
...
export function createValue(partialValue: Partial<$.youtube.Pqa>): $.youtube.Pqa {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.Pqa): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.Pqa {
...
export function encodeBinary(value: $.youtube.Pqa): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.Pqa {
  const result = getDefaultValue();
