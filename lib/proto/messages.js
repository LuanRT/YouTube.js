...
var ChannelAnalytics = exports.ChannelAnalytics = {
  buffer: true,
  encodingLength: null,
  encode: null,
  decode: null
...
function defineSearchFilter () {
  ...
  function encodingLength (obj) {
    ...
    if (defined(obj.filter)) {
      var len = encodings.int32.encodingLength(obj.filter)
      length += 1 + len
    }
  ...
  function encode (obj, buf, offset) {
    ...
    if (defined(obj.filter)) {
      buf[offset++] = 8
      encodings.int32.encode(obj.filter, buf, offset)
      offset += encodings.int32.encode.bytes
    }
    if (defined(obj.no_filter)) {
      buf[offset++] = 152
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      ...
      switch (tag) {
        case 1:
        obj.filter = encodings.int32.decode(buf, offset)
        offset += encodings.int32.decode.bytes
        break
        case 19:
