...
function defineInnertubePayload () {
  ...
  function defineContext () {
    ...
    function defineClient () {
      ...
      function encodingLength (obj) {
        var length = 0
        if (!defined(obj.unkparam)) throw new Error("unkparam is required")
        var len = encodings.int32.encodingLength(obj.unkparam)
        length += 2 + len
        if (!defined(obj.client_version)) throw new Error("client_version is required")
        var len = encodings.string.encodingLength(obj.client_version)
        length += 2 + len
        if (!defined(obj.client_name)) throw new Error("client_name is required")
  ...
  function defineSoundSearchParams () {
    ...
    function encodingLength (obj) {
      var length = 0
      if (!defined(obj.target_id)) throw new Error("target_id is required")
      var len = encodings.string.encodingLength(obj.target_id)
      length += 1 + len
      if (!defined(obj.query)) throw new Error("query is required")
...
function definePeformCommentActionParams () {
  ...
  function defineTranslateCommentParams () {
    ...
    function defineParams () {
      ...
      function encodingLength (obj) {
        var length = 0
        if (!defined(obj.comment)) throw new Error("comment is required")
    ...
    function encodingLength (obj) {
      var length = 0
      if (!defined(obj.params)) throw new Error("params is required")
      var len = Params.encodingLength(obj.params)
      length += varint.encodingLength(len)
      length += 1 + len
      if (!defined(obj.comment_id)) throw new Error("comment_id is required")
      var len = encodings.string.encodingLength(obj.comment_id)
      length += 1 + len
      if (!defined(obj.target_language)) throw new Error("target_language is required")
