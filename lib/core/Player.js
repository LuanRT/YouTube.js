...
import { default as default$0 } from "../deciphers/Signature.js";
import { default as default$1 } from "../deciphers/NToken.js";

const Cache = BROWSER ? browserCache : nodeCache;
const { default: Signature } = { default: default$0 };
const { default: NToken } = { default: default$1 };
/** @namespace */
class Player {
    #request;
    #player_id;
