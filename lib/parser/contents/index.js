class ResultsParser {
    static parseSearch(results) {
        return {
            contents: ResultsParser.parse(results.contents),
            refinements: results.refinements || [],
            estimated_results: parseInt(results.estimated_results),
        }
    }

    static parseChannel(results) {
        return {
            header: ResultsParser.parseItem(results.header),
            metadata: ResultsParser.parseItem(results.metadata),
            contents: ResultsParser.parse(results.contents),
        }
    }
