...
class NavigationEndpoint {
  ...
  constructor (item) {
    ...
    this.sign_in = item.signInEndpoint ? {
      next: item.signInEndpoint.nextEndpoint && new NavigationEndpoint(item.signInEndpoint.nextEndpoint)
    } : null;
    ...
    this.modal = modalRenderer ? {
      ...
      button: Parser.parseItem(modalRenderer.button),
      content: modalRenderer.content,
    } : null;
    // TODO: perform_comment_action
    this.perform_comment_action = item.performCommentActionEndpoint ? {
