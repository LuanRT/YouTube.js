...
| `po_token` | `string` | Send Google session information for solving the error "LOGIN_REQUIRED: This helps protect our community.". You can use the work of Invidious for generating those: https://github.com/iv-org/youtube-trusted-session-generator | `undefined` |
