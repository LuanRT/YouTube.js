...
export type Type = $.youtube.api.pfiinnertube.FormatId;

export function getDefaultValue(): $.youtube.api.pfiinnertube.FormatId {
  return {
    itag: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.FormatId>): $.youtube.api.pfiinnertube.FormatId {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.FormatId): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.FormatId {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.FormatId): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.FormatId {
  const result = getDefaultValue();
