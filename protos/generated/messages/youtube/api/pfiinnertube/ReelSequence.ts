...
export type Type = $.youtube.api.pfiinnertube.ReelSequence;

export function getDefaultValue(): $.youtube.api.pfiinnertube.ReelSequence {
  return {
    shortId: "",
    params: undefined,
    feature2: 0,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.ReelSequence>): $.youtube.api.pfiinnertube.ReelSequence {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.ReelSequence): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.ReelSequence {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.ReelSequence): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.ReelSequence {
  const result = getDefaultValue();
