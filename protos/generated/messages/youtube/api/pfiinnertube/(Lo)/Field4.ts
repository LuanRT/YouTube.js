...
export declare namespace $.youtube.api.pfiinnertube.Lo {
  export type Field4 = {
    field1?: number;
    field2?: number;
    field3?: number;
...
export type Type = $.youtube.api.pfiinnertube.Lo.Field4;

export function getDefaultValue(): $.youtube.api.pfiinnertube.Lo.Field4 {
  return {
    field1: undefined,
    field2: undefined,
    field3: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.Lo.Field4>): $.youtube.api.pfiinnertube.Lo.Field4 {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.Lo.Field4): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.Lo.Field4 {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.Lo.Field4): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.Lo.Field4 {
  const result = getDefaultValue();
