...
export type Type = $.youtube.api.pfiinnertube.Lo;

export function getDefaultValue(): $.youtube.api.pfiinnertube.Lo {
  return {
    formatId: undefined,
    Lj: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.Lo>): $.youtube.api.pfiinnertube.Lo {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.Lo): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.Lo {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.Lo): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.Lo {
  const result = getDefaultValue();
