...
export declare namespace $.youtube.api.pfiinnertube.MusicSearchFilter.Filters {
  export type Type = {
    song?: number;
    video?: number;
    album?: number;
...
export type Type = $.youtube.api.pfiinnertube.MusicSearchFilter.Filters.Type;

export function getDefaultValue(): $.youtube.api.pfiinnertube.MusicSearchFilter.Filters.Type {
  return {
    song: undefined,
    video: undefined,
    album: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.MusicSearchFilter.Filters.Type>): $.youtube.api.pfiinnertube.MusicSearchFilter.Filters.Type {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.MusicSearchFilter.Filters.Type): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.MusicSearchFilter.Filters.Type {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.MusicSearchFilter.Filters.Type): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.MusicSearchFilter.Filters.Type {
  const result = getDefaultValue();
