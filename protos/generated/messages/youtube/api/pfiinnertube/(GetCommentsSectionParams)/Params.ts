...
export type Type = $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params;

export function getDefaultValue(): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params {
  return {
    unkToken: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.GetCommentsSectionParams.Params>): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params {
  const result = getDefaultValue();
