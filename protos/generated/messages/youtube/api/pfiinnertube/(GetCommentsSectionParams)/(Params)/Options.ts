...
export type Type = $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.Options;

export function getDefaultValue(): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.Options {
  return {
    videoId: "",
    sortBy: 0,
    type: 0,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.Options>): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.Options {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.Options): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.Options {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.Options): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.Options {
  const result = getDefaultValue();
