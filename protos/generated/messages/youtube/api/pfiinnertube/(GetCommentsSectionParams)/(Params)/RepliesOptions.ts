...
} from "./(RepliesOptions)/UnkOpts.js";
import {
...
export declare namespace $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params {
...
export type Type = $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.RepliesOptions;

export function getDefaultValue(): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.RepliesOptions {
  return {
    commentId: "",
    unkopts: undefined,
    channelId: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.RepliesOptions>): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.RepliesOptions {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.RepliesOptions): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.RepliesOptions {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.RepliesOptions): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.GetCommentsSectionParams.Params.RepliesOptions {
  const result = getDefaultValue();
