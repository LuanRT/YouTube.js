...
export type Type = $.youtube.api.pfiinnertube.FormatInitializationMetadata;

export function getDefaultValue(): $.youtube.api.pfiinnertube.FormatInitializationMetadata {
  return {
    videoId: undefined,
    formatId: undefined,
    endTimeMs: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.FormatInitializationMetadata>): $.youtube.api.pfiinnertube.FormatInitializationMetadata {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.FormatInitializationMetadata): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.FormatInitializationMetadata {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.FormatInitializationMetadata): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.FormatInitializationMetadata {
  const result = getDefaultValue();
