...
} from "./(NotificationPreferences)/Preference.js";
import {
...
export type Type = $.youtube.api.pfiinnertube.NotificationPreferences;

export function getDefaultValue(): $.youtube.api.pfiinnertube.NotificationPreferences {
  return {
    channelId: "",
    prefId: undefined,
    number0: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.NotificationPreferences>): $.youtube.api.pfiinnertube.NotificationPreferences {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.NotificationPreferences): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.NotificationPreferences {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.NotificationPreferences): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.NotificationPreferences {
  const result = getDefaultValue();
