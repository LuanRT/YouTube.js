...
export type Type = $.youtube.api.pfiinnertube.SabrRequest;

export function getDefaultValue(): $.youtube.api.pfiinnertube.SabrRequest {
  return {
    mediaInfo: undefined,
    formatIds: [],
    ud: [],
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.SabrRequest>): $.youtube.api.pfiinnertube.SabrRequest {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.SabrRequest): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.SabrRequest {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.SabrRequest): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.SabrRequest {
  const result = getDefaultValue();
