...
export type Type = $.youtube.api.pfiinnertube.MediaHeader;

export function getDefaultValue(): $.youtube.api.pfiinnertube.MediaHeader {
  return {
    headerId: undefined,
    videoId: undefined,
    itag: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.MediaHeader>): $.youtube.api.pfiinnertube.MediaHeader {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.MediaHeader): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.MediaHeader {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.MediaHeader): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.MediaHeader {
  const result = getDefaultValue();
