...
export type Type = $.youtube.api.pfiinnertube.PlaybackCookie;

export function getDefaultValue(): $.youtube.api.pfiinnertube.PlaybackCookie {
  return {
    field1: undefined,
    field2: undefined,
    videoFmt: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.PlaybackCookie>): $.youtube.api.pfiinnertube.PlaybackCookie {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.PlaybackCookie): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.PlaybackCookie {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.PlaybackCookie): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.PlaybackCookie {
  const result = getDefaultValue();
