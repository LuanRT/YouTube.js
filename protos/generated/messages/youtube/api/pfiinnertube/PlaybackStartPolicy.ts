...
export type Type = $.youtube.api.pfiinnertube.PlaybackStartPolicy;

export function getDefaultValue(): $.youtube.api.pfiinnertube.PlaybackStartPolicy {
  return {
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.PlaybackStartPolicy>): $.youtube.api.pfiinnertube.PlaybackStartPolicy {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.PlaybackStartPolicy): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.PlaybackStartPolicy {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.PlaybackStartPolicy): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.PlaybackStartPolicy {
  const result = getDefaultValue();
