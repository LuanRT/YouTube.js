...
export type Type = $.youtube.api.pfiinnertube.RequestCancellationPolicy;

export function getDefaultValue(): $.youtube.api.pfiinnertube.RequestCancellationPolicy {
  return {
    N0: undefined,
    items: [],
    jq: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.RequestCancellationPolicy>): $.youtube.api.pfiinnertube.RequestCancellationPolicy {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.RequestCancellationPolicy): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.RequestCancellationPolicy {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.RequestCancellationPolicy): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.RequestCancellationPolicy {
  const result = getDefaultValue();
