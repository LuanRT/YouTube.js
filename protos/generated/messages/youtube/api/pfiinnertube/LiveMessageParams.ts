...
export type Type = $.youtube.api.pfiinnertube.LiveMessageParams;

export function getDefaultValue(): $.youtube.api.pfiinnertube.LiveMessageParams {
  return {
    params: undefined,
    number0: undefined,
    number1: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.LiveMessageParams>): $.youtube.api.pfiinnertube.LiveMessageParams {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.LiveMessageParams): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.LiveMessageParams {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.LiveMessageParams): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.LiveMessageParams {
  const result = getDefaultValue();
