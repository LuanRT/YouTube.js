...
export type Type = $.youtube.api.pfiinnertube.OnesieRequest;

export function getDefaultValue(): $.youtube.api.pfiinnertube.OnesieRequest {
  return {
    url: undefined,
    headers: [],
    body: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.OnesieRequest>): $.youtube.api.pfiinnertube.OnesieRequest {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.OnesieRequest): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.OnesieRequest {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.OnesieRequest): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.OnesieRequest {
  const result = getDefaultValue();
