...
export type Type = $.youtube.api.pfiinnertube.GetCommentsSectionParams;

export function getDefaultValue(): $.youtube.api.pfiinnertube.GetCommentsSectionParams {
  return {
    ctx: undefined,
    unkParam: 0,
    params: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.GetCommentsSectionParams>): $.youtube.api.pfiinnertube.GetCommentsSectionParams {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.GetCommentsSectionParams): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.GetCommentsSectionParams {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.GetCommentsSectionParams): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.GetCommentsSectionParams {
  const result = getDefaultValue();
