...
export type Type = $.youtube.api.pfiinnertube.NextRequestPolicy;

export function getDefaultValue(): $.youtube.api.pfiinnertube.NextRequestPolicy {
  return {
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.NextRequestPolicy>): $.youtube.api.pfiinnertube.NextRequestPolicy {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.NextRequestPolicy): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.NextRequestPolicy {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.NextRequestPolicy): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.NextRequestPolicy {
  const result = getDefaultValue();
