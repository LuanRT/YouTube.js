...
export type Type = $.youtube.api.pfiinnertube.OQa;

export function getDefaultValue(): $.youtube.api.pfiinnertube.OQa {
  return {
    field1: [],
    field2: undefined,
    field3: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.OQa>): $.youtube.api.pfiinnertube.OQa {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.OQa): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.OQa {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.OQa): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.OQa {
  const result = getDefaultValue();
