...
export type Type = $.youtube.api.pfiinnertube.Upa;

export function getDefaultValue(): $.youtube.api.pfiinnertube.Upa {
  return {
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.Upa>): $.youtube.api.pfiinnertube.Upa {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.Upa): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.Upa {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.Upa): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.Upa {
  const result = getDefaultValue();
