...
export type Type = $.youtube.api.pfiinnertube.YPa;

export function getDefaultValue(): $.youtube.api.pfiinnertube.YPa {
  return {
    field1: undefined,
    field2: undefined,
    field3: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.YPa>): $.youtube.api.pfiinnertube.YPa {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.YPa): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.YPa {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.YPa): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.YPa {
  const result = getDefaultValue();
