...
export type Type = $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities.VideoFormatCapability;

export function getDefaultValue(): $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities.VideoFormatCapability {
  return {
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities.VideoFormatCapability>): $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities.VideoFormatCapability {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities.VideoFormatCapability): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities.VideoFormatCapability {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities.VideoFormatCapability): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities.VideoFormatCapability {
  const result = getDefaultValue();
