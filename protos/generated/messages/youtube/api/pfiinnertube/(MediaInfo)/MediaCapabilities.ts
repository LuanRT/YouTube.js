...
export type Type = $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities;

export function getDefaultValue(): $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities {
  return {
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities>): $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.MediaInfo.MediaCapabilities {
  const result = getDefaultValue();
