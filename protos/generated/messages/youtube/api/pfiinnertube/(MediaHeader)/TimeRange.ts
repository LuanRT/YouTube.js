...
export type Type = $.youtube.api.pfiinnertube.MediaHeader.TimeRange;

export function getDefaultValue(): $.youtube.api.pfiinnertube.MediaHeader.TimeRange {
  return {
    field1: undefined,
    field2: undefined,
    field3: undefined,
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.MediaHeader.TimeRange>): $.youtube.api.pfiinnertube.MediaHeader.TimeRange {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.MediaHeader.TimeRange): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.MediaHeader.TimeRange {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.MediaHeader.TimeRange): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.MediaHeader.TimeRange {
  const result = getDefaultValue();
