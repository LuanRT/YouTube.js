...
export declare namespace $.youtube.api.pfiinnertube.PlaybackStartPolicy {
...
export type Type = $.youtube.api.pfiinnertube.PlaybackStartPolicy.ReadaheadPolicy;

export function getDefaultValue(): $.youtube.api.pfiinnertube.PlaybackStartPolicy.ReadaheadPolicy {
  return {
...
export function createValue(partialValue: Partial<$.youtube.api.pfiinnertube.PlaybackStartPolicy.ReadaheadPolicy>): $.youtube.api.pfiinnertube.PlaybackStartPolicy.ReadaheadPolicy {
  return {
    ...getDefaultValue(),
    ...partialValue,
  };
...
export function encodeJson(value: $.youtube.api.pfiinnertube.PlaybackStartPolicy.ReadaheadPolicy): unknown {
  const result: any = {};
...
export function decodeJson(value: any): $.youtube.api.pfiinnertube.PlaybackStartPolicy.ReadaheadPolicy {
...
export function encodeBinary(value: $.youtube.api.pfiinnertube.PlaybackStartPolicy.ReadaheadPolicy): Uint8Array {
...
export function decodeBinary(binary: Uint8Array): $.youtube.api.pfiinnertube.PlaybackStartPolicy.ReadaheadPolicy {
  const result = getDefaultValue();
